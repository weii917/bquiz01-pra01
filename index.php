		...
		<div id="ms">
			<div id="lf" style="float:left;">
				<div id="menuput" class="dbor">
					...
					<?php
					$mainmu = $Menu->all(['menu_id' => 0]);
					foreach ($mainmu as $menu) {
					?>
						<div class="mainmu">
				...
				<div style="width:89%; height:480px;" class="dbor">
					...
					?>
						<div id="ssaa<?= $idx; ?>" class="im cent">
							<img src="./img/<?= $img['img']; ?>" style="width:150px;height:103px;margin:5px;border:3px solid orange">
						</div>
					<?php
					}
					?>
