            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><input style="width:90%" type="text" name="href[]" value="<?= $row['href']; ?>"></td>
                        <td><?= $DB->count(['menu_id' => $row['id']]); ?></td>
                        <td><input type="checkbox" name="sh[]" value="<?= $row['id']; ?>" <?= ($row['sh'] == 1) ? 'checked' : ''; ?>></td>
                        <td><input type="checkbox" name="del[]" value="<?= $row['id']; ?>"></td>
                        <td width="200px"><input type="button" onclick="op('#cover','#cvr','./modal/submenu.php?table=<?= $do; ?>&id=<?=$row['id'];?>')" value="編輯次選單"></td>
